...
**Lights:** <br>
Sensors polled in 80Hz mode = 12.5ms period. Average latency is 12.5/2 ms plus a little more since six sensors are polled in succession, let's call it 10ms. Filtering on sensor input is basic to avoid delays. Result: light feels instant to a user. 
